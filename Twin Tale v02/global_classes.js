...
class Player_SideScroll
{
    ...
    update()
    {
        ...
        //controller
        if(userInput.up && this.isGrounded && this.jumpCooldown == 0)
        {
            this.velocity.y = -16
        ...
        //frame control
        if(this.frame >= 2) this.frameCountIsProgressive = false
        if(this.frame == 0) this.frameCountIsProgressive = true
...
class Scenery_obj
{
    constructor({src, srcsize, pos1, pos2, update, span})
    {
        this.img = new Image()
        src != undefined ? this.img.src = src : false
        srcsize != undefined ? this.imgsize = srcsize : this.imgsize = { x: 800, y: 600}
        this.initialframe = 1
        span != undefined ? this.span = span : this.span = 0
